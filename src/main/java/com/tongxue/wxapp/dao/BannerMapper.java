...
public interface BannerMapper {
    @Select("select a.bannerId,a.bannerName,a.ptid,b.pt_name,a.pdid,c.product_name,a.image from banner a " +
            "left join product_type b on a.ptid=b.pt_id left join product c on a.pdid=c.product_id where a.statu=0")
    ...
    @Select("select a.bannerId,a.bannerName,a.ptid,b.pt_name,a.pdid,c.product_name,a.image from banner a " +
            "left join product_type b on a.ptid=b.pt_id left join product c on a.pdid=c.product_id where a.statu=1")
    List<Banner> selectList1 ();
